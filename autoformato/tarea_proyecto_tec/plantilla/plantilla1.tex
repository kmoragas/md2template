...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,-2.3) {\includegraphics[width=\paperwidth,height=30cm]{figures/PIA21073large.jpg}}; % Background image
...
\coordinate [below=10.15cm,left=3cm] (objectivopoint) at (current page.north);
\coordinate [below=10.5cm,left=3cm] (datosgeneralespoint) at (current page.north);
